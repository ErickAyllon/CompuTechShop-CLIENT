...
//   const thisUserOrders = orders.filter(e => e.userEmail === user.userEmail ? e : false)
  ...
  return (
    <div className={styles.myOrders}>
        { !watch?
            <div>
                <Button onClick={watchOrders}>Watch orders</Button>
            </div>
            : 
            <div>
                <Button onClick={watchOrders}>Close orders</Button>
            </div>
        }
        <div>
            {watch && orders.length > 0 ? 
                <div className={styles.tabla}>
                <Paper sx={{ width: '100%', background:'white', borderTop:'1px solid gray'}}>
